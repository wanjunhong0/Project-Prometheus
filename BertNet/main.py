...
===========================================================================
"""
parser = argparse.ArgumentParser(description="Run BertNet.")
...
parser.add_argument('--k', type=int, default=4, help='k-th Propagation')
...
norm_adj_ = data.norm_adj_.to(device)
...
"""
# Model and optimizer
model = BertNet(k=args.k, n_feature=data.n_feature, n_hidden=args.hidden,
...
for epoch in range(1, args.epoch+1):
    ...
    model.train()
    optimizer.zero_grad()
    output = model(feature, norm_adj, norm_adj_)[data.idx_train]
    ...
    # Validation
    model.eval()
    output = model(feature, norm_adj, norm_adj_)[data.idx_val]
...
"""
model.eval()
output = model(feature, norm_adj, norm_adj_)[data.idx_test]
