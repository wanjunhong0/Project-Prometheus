...
===========================================================================
"""
parser = argparse.ArgumentParser(description="Run FAGCN.")
...
"""
# Model and optimizer
model = FAGCN(n_layer=args.layer, n_feature=data.n_feature, n_hidden=args.hidden,
              n_class=data.n_class, dropout=args.dropout, eps=args.eps).to(device)
