...
===========================================================================
"""
data = Data(path=args.data_path, dataset=args.dataset, split=args.split, n_layer=args.layer)
...
"""
# Model and optimizer
model = SIGN(n_feature=data.n_feature, n_hidden=args.hidden, n_class=data.n_class, n_layer=args.layer, dropout=args.dropout).to(device)
