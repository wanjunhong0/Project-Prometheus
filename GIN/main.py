...
===========================================================================
"""
parser = argparse.ArgumentParser(description="Run GIN.")
...
parser.add_argument('--eps', type=float, default=0.5, help='Eps value')
...
===========================================================================
"""
data = Data(path=args.data_path, dataset=args.dataset, split=args.split, eps=args.eps)
...
"""
# Model and optimizer
model = GIN(n_layer=args.layer, n_feature=data.n_feature, n_hidden=args.hidden,
...
for epoch in range(1, args.epoch+1):
    ...
    model.train()
    optimizer.zero_grad()
    output = model(feature, adj)[data.idx_train]
    ...
    # Validation
    model.eval()
    output = model(feature, adj)[data.idx_val]
...
"""
model.eval()
output = model(feature, adj)[data.idx_test]
