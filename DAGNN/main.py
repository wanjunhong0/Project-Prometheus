...
===========================================================================
"""
parser = argparse.ArgumentParser(description="Run DAGNN.")
...
"""
# Model and optimizer
model = DAGNN(n_feature=data.n_feature, n_hidden=args.hidden, n_class=data.n_class, k=args.k, dropout=args.dropout).to(device)
