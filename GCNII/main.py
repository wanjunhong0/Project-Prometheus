...
===========================================================================
"""
parser = argparse.ArgumentParser(description="Run GCNII.")
...
"""
# Model and optimizer
model = GCNII(n_layer=args.layer, n_feature=data.n_feature, n_hidden=args.hidden,
              n_class=data.n_class, dropout=args.dropout, alpha=args.alpha, theta=args.theta).to(device)
