...
===========================================================================
"""
parser = argparse.ArgumentParser(description="Run JKnet.")
...
parser.add_argument('--mode', type=str, default='cat', help='cat/max')
...
"""
# Model and optimizer
model = JKnet(n_layer=args.layer, n_feature=data.n_feature, n_hidden=args.hidden,
              n_class=data.n_class, dropout=args.dropout, mode=args.mode).to(device)
