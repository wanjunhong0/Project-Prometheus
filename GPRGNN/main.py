...
===========================================================================
"""
parser = argparse.ArgumentParser(description="Run GPRGNN.")
...
parser.add_argument('--k', type=int, default=10, help='k-th Propagation')
...
"""
# Model and optimizer
model = GPRGNN(k=args.k, n_feature=data.n_feature, n_hidden=args.hidden,
               n_class=data.n_class, dropout=args.dropout, alpha=args.alpha).to(device)
