...
===========================================================================
"""
parser = argparse.ArgumentParser(description="Run GCN+DropEdge.")
...
parser.add_argument('--rate', type=float, default=0.8, help='The percent of the preserve edges. If it equals 1, no sampling is done on adj matrix')
...
norm_adj = sampler.DropEdge(args.rate).to(device)
